...
def log_validation(
    ...
    for i, video in enumerate(videos):
        ...
        video_id = f"{phase_name}_step_{step}_rank_{accelerator.process_index}_video_{i}_{prompt}.mp4"
...
def main(args):
    ...
    train_dataloader = DataLoader(
        ...
        sampler=BucketSampler(train_dataset, global_batch_size=args.train_batch_size * accelerator.num_processes, shuffle=True),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs/lora_config.py",
